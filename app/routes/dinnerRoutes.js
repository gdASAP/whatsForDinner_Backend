...
router.get('/dinner/:id', requireToken, (req, res, next) => {
  ...
  Dinner.findById(req.params.id)
    ...
    .then(dinner => res.status(200).json({ dinner: dinner.toObject() }))
    // if an error occurs, pass it to the handler
    .catch(next)
})
...
// UPDATE
// PATCH /dinner/5a7db6c74d55bc51bdf39793
router.patch('/dinner/:id', requireToken, removeBlanks, (req, res, next) => {
...
// DESTROY
// DELETE /dinner/5a7db6c74d55bc51bdf39793
router.delete('/dinner/:id', requireToken, (req, res, next) => {
  Dinner.findById(req.params.id)
    .then(handle404)
    .then(dinner => {
